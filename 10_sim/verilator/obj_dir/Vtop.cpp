...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , top_MemWriteM{vlSymsp->TOP.top_MemWriteM}
    , top_pcF{vlSymsp->TOP.top_pcF}
    , top_InstrF{vlSymsp->TOP.top_InstrF}
    , top_ReadDataM{vlSymsp->TOP.top_ReadDataM}
    , top_WriteDataM{vlSymsp->TOP.top_WriteDataM}
    , top_ALUResultM{vlSymsp->TOP.top_ALUResultM}
    , rootp{&(vlSymsp->TOP)}
{
